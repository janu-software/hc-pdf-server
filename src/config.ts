...
const DEFAULT_BROWSER_LAUNCH_ARGS =
  "--no-sandbox;--disable-setuid-sandbox;--disable-gpu;--disable-dev-shm-usage;--proxy-server='http://mhiaebta-rotate:twqlubqx2pvs@p.webshare.io:80';--proxy-bypass-list=<-loopback>,*.gas-online.cz"
